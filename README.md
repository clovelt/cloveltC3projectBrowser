...
📁 /
├── 📁 MyAwesomeGame/
│   ├── 📄 MyAwesomeGame.zip           # (Required) The base file to be listed.
│   ├── 📄 MyAwesomeGame.txt           # (Optional) A text file with metadata for the preview.
│   ├── 📄 MyAwesomeGame_icon.png      # (Optional) An icon for the file tree and preview header.
│   ├── 📄 MyAwesomeGame.gif           # (Optional) A preview image/GIF.
│   ├── 📄 MyAwesomeGame_web.zip       # (Optional) "Download Web" button will appear.
│   ├── 📄 MyAwesomeGame_win.zip       # (Optional) "Download Windows" button will appear.
│   ├── 📄 MyAwesomeGame_mac.zip       # (Optional) "Download Mac" button will appear.
│   └── 📄 MyAwesomeGame.c3p           # (Optional) "Download Source" button will appear.
│
├── 📁 MySecretProject/
